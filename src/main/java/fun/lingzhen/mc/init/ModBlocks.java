...
public class ModBlocks {
    ...
    public static final Block CATE_HOPPER = register(
            "cate_hopper",
            CateHopperBlock::new,
    ...
    private static RegistryKey<Block> keyOfBlock(String name) {
        return RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(UselessRedstone.MOD_ID, name));
    }

    private static RegistryKey<Item> keyOfItem(String name) {
        return RegistryKey.of(RegistryKeys.ITEM, Identifier.of(UselessRedstone.MOD_ID, name));
    }
